...
import TeamSectionSSR from '../../components/team/TeamSectionSSR';
import campesinosImage from '../../assets/campesinos.jpg';

// Versión simplificada de AboutUs para SSR (sin Framer Motion)
const AboutUsSSR: React.FC = () => (
  <section
    id="about-us"
  ...
  >
    <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
      ...
      <div className="flex-1 text-center md:text-left space-y-6 flex flex-col items-center md:items-start">
        ...
        <p className="text-lg text-slate-700 max-w-3xl justify-normal">
