...
// Componente SplitText personalizado
  ...
  return (
    ...
    >
      <section className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden mt-12">
          ...
          <div className="relative z-10 mx-auto px-4 py-20" style={{ maxWidth: '84rem' }}>
            ...
            {/* Badge */}
                <motion.div
                  ...
                  className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800"
                >
                  <Zap size={16} className="mr-2" />
                  AgriTech de Próxima Generación
                </motion.div>

            {/* Título principal con SplitText */}
                <motion.div
                ...
                >
                  ...
                  />
                  <SplitText
                    text="para monitorear cultivos."
                    className="text-4xl md:text-6xl font-bold leading-tight bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent block"
                    stagger={0.1}
                    delay={0.8}
                    duration={0.5}
                  />
            ...
            <div className="p-8 bg-white/80 backdrop-blur-sm border-2 border-emerald-200 shadow-2xl rounded-xl">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <motion.div
                  ...
                  className="flex items-center space-x-2 p-3 bg-teal-50 rounded-lg border border-teal-200"
                >
                ...
                <motion.div
                  ...
                  className="flex items-center space-x-2 p-3 bg-cyan-50 rounded-lg border border-cyan-200"
                >
        ...
        {/* Stats Section - integrada en el Hero */}
        <div className="mt-20">
