              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  {average && (
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 p-4 rounded-xl"
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <Activity className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                        <h3 className="font-semibold text-slate-700 dark:text-slate-300">Promedio</h3>
                      </div>
                  ...
                  {minimum && (
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 p-4 rounded-xl"
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <TrendingDown className="h-5 w-5 text-green-600 dark:text-green-400" />
                        <h3 className="font-semibold text-slate-700 dark:text-slate-300">Mínimo</h3>
                      </div>
                  ...
                  {maximum && (
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 p-4 rounded-xl"
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <TrendingUp className="h-5 w-5 text-red-600 dark:text-red-400" />
                        <h3 className="font-semibold text-slate-700 dark:text-slate-300">Máximo</h3>
                      </div>
                  ...
                  {stdDev && (
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 p-4 rounded-xl"
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <Activity className="h-5 w-5 text-purple-600 dark:text-purple-400" />
                        <h3 className="font-semibold text-slate-700 dark:text-slate-300">Desviación</h3>
                      </div>
                ...
                {trend && (
                  <motion.div
                    ...
                    className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 p-4 rounded-xl mb-6"
                  >
                    <h3 className="font-semibold text-slate-700 dark:text-slate-300 mb-2">Tendencia</h3>
