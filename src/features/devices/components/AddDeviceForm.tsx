      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        >
          <form
            onSubmit={(e) => {
              ...
              console.log('📝 Device form canSubmit:', form.state.canSubmit);
              console.log('📝 Device form errors:', form.state.errors);
              form.handleSubmit();
            }}
            className="space-y-6"
          >
        ...
        {createDeviceMutation.isError && (
          ...
          >
            ...
            <div>
              <p className="text-red-700 font-medium">Error al crear el dispositivo</p>
        ...
        {createDeviceMutation.isSuccess && (
          ...
          >
            ...
            <div>
              <p className="text-green-700 font-medium">¡Dispositivo creado exitosamente!</p>
