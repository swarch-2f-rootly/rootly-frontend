...
import { useDevices } from '../plants/api/plantApi'
import {
  Plus,
  Cpu,
  Activity,
...
const DevicesListPage: React.FC = () => {
  ...
  // Filter devices based on search (client-side filtering)
        ...
        {isLoading && (
          ...
          >
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-emerald-700 font-medium">Cargando dispositivos...</p>
            </div>
          </motion.div>
        )}
