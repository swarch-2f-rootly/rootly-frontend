...
import { useCreatePlant, useUploadPlantPhoto } from '../api/plantApi';
...
const AddPlantForm: React.FC = () => {
  ...
  console.log('AddPlantForm Debug:', {
    user,
    userId: user?.id,
  ...
  const form = useForm({
    ...
    // Remove form-level validation that's causing issues
  });
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        {createPlantMutation.isError && (
          ...
          >
            ...
            <div>
              <p className="text-red-700 font-medium">Error al crear la planta</p>
        ...
        {uploadError && !createPlantMutation.isError && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div>
              <p className="text-amber-700 font-medium">Advertencia</p>
              <p className="text-amber-600 text-sm">{uploadError}</p>
            </div>
          </motion.div>
        )}
      </div>
