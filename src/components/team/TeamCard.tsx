...
const TeamCard: React.FC<TeamCardProps> = ({ username, delay = 0 }) => {
    ...
    >
      ...
      <div className="flex justify-center mb-4">
        <motion.img
          ...
          className="w-16 h-16 rounded-full border-3 border-emerald-200 shadow-lg group-hover:border-emerald-400 transition-colors duration-300"
      ...
      {/* Bio */}
      {profile.bio && (
        <p className="text-slate-600 text-xs text-center mb-3 line-clamp-2">
          {profile.bio}
        </p>
      )}
