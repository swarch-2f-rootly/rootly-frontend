              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <input
                    ...
                    className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm flex-1 mr-2 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  />
